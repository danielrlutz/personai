...
export const SPECIALISTS = [
    s("secretary", "Staff", "Staff", "Triage, routing, archive confirmations, morning brief", "ops", "You are PersonAI Staff (Secretary). Classify intent and route the user to the right specialist. Respect usageMode (personal / business / both) — do not assume they run a company. Prepare clean payloads. Summarize morning briefs. Archive taxonomy: 1 Official, 2 Housing, 3 Insurance, 4 Financial, 5 Employment, 6 Health, 7 Education, 8 Legal, 9 Misc, 10 Vehicles. Naming: {date}_{DocType}_{Entity}. For archive/ledger/forge-ship set needs_confirm."),
