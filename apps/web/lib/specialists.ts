...
export const SPECIALIST_FALLBACK: SpecialistMeta[] = [
  ...
  { id: "legal_aide", label: "Legal Aide", shortLabel: "Legal", description: "Contracts, court papers, Fristen", group: "ops" },
  { id: "medical_integrator", label: "Medical Integrator", shortLabel: "Medical", description: "Records, symptoms, care timelines", group: "care" },
